...
#include "../../TaskTrackingSystem/addTaskWindow.h"
...
QT_MOC_LITERAL(1, 14, 11), // "updateTable"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 27) // "on_createTaskButton_clicked"

    },
    "AddTaskWindow\0updateTable\0\0"
...
void AddTaskWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_createTaskButton_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AddTaskWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddTaskWindow::updateTable)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AddTaskWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_AddTaskWindow.data,
      qt_meta_data_AddTaskWindow,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void AddTaskWindow::updateTable()
{
